...
class PersonAddressController {
    ...
    public ResponseEntity<PersonAddress> getById(@PathVariable("id") String id) {
    ...
    public ResponseEntity<PersonAddress> update(@PathVariable("id") String id, @RequestBody PersonAddress item) {
        Optional<PersonAddress> existingItemOptional = repository.findById(id);
        if (existingItemOptional.isPresent()) {
